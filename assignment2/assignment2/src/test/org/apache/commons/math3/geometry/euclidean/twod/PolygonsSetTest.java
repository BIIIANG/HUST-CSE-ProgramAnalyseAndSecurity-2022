...
public class PolygonsSetTest {
    ...
    public void testSimplyConnected() {
        ...
        Assert.assertEquals(Location.OUTSIDE, set.checkPoint(new Vector2D(50.0, 30.0)));
        checkPoints(Location.INSIDE, set, new Vector2D[] {
        ...
        checkPoints(Location.OUTSIDE, set, new Vector2D[] {
        ...
        checkPoints(Location.BOUNDARY, set, new Vector2D[] {
    ...
    public void testDisjointPolygons() {
        ...
        PolygonsSet set = buildSet(vertices);
        Assert.assertEquals(Location.INSIDE, set.checkPoint(new Vector2D(1.0, 1.5)));
        checkPoints(Location.INSIDE, set, new Vector2D[] {
    ...
    public void testBug20040520() {
        ...
        checkPoints(Location.INSIDE, c, new Vector2D[] {
        ...
        checkPoints(Location.OUTSIDE, c, new Vector2D[] {
    ...
    private void checkPoints(Location expected, PolygonsSet set,
                             Vector2D[] points) {
